...
const Meal = () => {
  ...
  return (
    <div className="max-w-[1520px] m-auto px-5 py-12">
      <h1 className="title">
        Our Meal
      </h1>
      <div className="flex flex-col lg:flex-row justify-center">
        <div className="flex justify-center md:justify-center py-4">
          ...
          className="m-1 border-orange-700 text-white hover:bg-white bg-orange-700 hover:text-orange-700 hover:border-orange-700">
            All
          </button>
          <button
