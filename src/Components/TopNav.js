  ...
  return (
    <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
      <div className="flex items-center">
        <div onClick={()=>setSideNav(!sideNav)} className="cursor-pointer pr-1">
          <AiOutlineMenu size={25} />
        </div>
        <h1 className="text-2xl sm:text-3xl lg:text-4xl mx-1">
          Yum
          <span className="font-bold">Eats</span>
        </h1>
        <div className="hidden lg:flex items-center bg-gray-200 rounded-full mr-1 p-1 text-[14px]">
        <p className="bg-orange-700 text-white rounded-full p-2 text-bold">Free</p>
        <p className="p2- text-bold">Delivery</p>
        </div>
      </div>
      ...
      <button className="bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full border-white">
      <BsFillCartFill className="mx-1"/>  cart 
      </button>
      {
